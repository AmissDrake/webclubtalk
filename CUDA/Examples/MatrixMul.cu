...
int main() {
    ...
    cudaEventElapsedTime(&gpu_time_actual, start_total, stop_total);

    printf("Matrix multiplication of 2 %dx%d matrices took %f seconds.\n", N, N, gpu_time / 1000.0f);
    printf("Matrix multiplication of 2 %dx%d matrices took %f seconds including memory operations.\n", N, N, gpu_time_actual / 1000.0f);
